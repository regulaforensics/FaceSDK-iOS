...
class ImageQualityViewController: UIViewController {
    ...
    private func sendDetectFacesRequest() {
        ...
        case .customScenario:
            ...
            config.customQuality = [
                ...
                ImageQualityGroup.HeadOcclusion.headphones().withCustomValue(0),
                ImageQualityGroup.HeadOcclusion.headCovering().withCustomValue(0),
    ...
    @objc private func didPressPickPhoto(_ sender: Any) {
        imagePicker.presentDefaultActions(from: galleryView)
    }
