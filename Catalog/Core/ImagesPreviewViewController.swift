...
final class ImagesPreviewViewController: UIViewController {
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            imageView.topAnchor.constraint(equalTo: self.view.safeTopAnchor),
        ...
        NSLayoutConstraint.activate([
            nextButton.bottomAnchor.constraint(equalTo: self.view.safeBottomAnchor, constant: -40),
